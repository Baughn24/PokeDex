...
//NOTE: The value/argument that will be passed in for the "pokemon" parameter will be the response received from the AAxios request to the PokeAPI
...
//NOTE: The argumnent/value passed into the "id" parameter will be a number created in the loop in the next functions (AKA The getPokemon function)
